        ...
        <div className="container">
          <div className="section-heading text-center">
            ...
            <p className="text-muted">
              Check out what you can do with HuntJob application
            </p>
            <hr />
          </div>
          <div className="row">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <div className="feature-item">
                      ...
                      <p className="text-muted">
                        You can take a snapshot of your credentials as part of
                        your CV before job Offer
                      </p>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-lg-6">
                    <div className="feature-item">
                      ...
                      <h3>Free to Use</h3>
                      <p className="text-muted">
                        You can get free notifications when you register for
                  ...
                  <div className="col-lg-6">
                    <div className="feature-item">
                      ...
                      <h3>Security</h3>
                      <p className="text-muted">
                        Trust us to give you a better job offer, and ensure you
